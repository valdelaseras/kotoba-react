          ...
          <Form id={'settings-form'} onSubmit={this.submitHandler}>
              ...
              <Content colSize={'column two'}>
                <Fieldset title={'Exams'}>
                  <FormGroup key={'exam-settings'} id={'exam-settings'}>
                    ...
                    <p>Set your preference on handling incorrectly answered questions.</p>
                    ...
                    <FormField key={'repeat-settings'} value={this.state.settings.examSettings.repeat}>
                      <Select
                        ...
                        text={
                          'By default, questions you answered incorrectly will be repeated again at the end of your exam until you answer them correctly. You may also choose to disable this.'
                        }
                        id={'repeat-select'}
                ...
                <Fieldset title={'Visual preferences'}>
                  <FormGroup key={'visual-settings'} id={'visual-settings'}>
                    ...
                    <FormField key={'theme-select'} value={this.state.settings.visualSettings.theme}>
                      <Select name={'theme'} id={'theme-select'} children={themeOptions} />
                    </FormField>
                    <h3>Text preference</h3>
                    <p>For kids who can't read good and want to learn how to do other stuff good too</p>
                    ...
                    <FormField key={'font-size-select'} value={this.state.settings.visualSettings.fontSize}>
                      <Select name={'font-size'} title={'Font size'} id={'fs-select'} children={fontSizeOptions} />
                    </FormField>
                  </FormGroup>
                </Fieldset>
              </Content>
            ...
            <Row colSize={'column'}>
              <Content colSize={'column two'}>
                ...
                <Button key={'settings-form-btn'} type={'submit'} title={'Save'} className={'btn-primary btn-main'} />
              </Content>
            </Row>
          </Form>
        </Row>
