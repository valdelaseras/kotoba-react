          ...
          <Row colSize={'column two'}>
            <Content colSize={'column'}>
              <Fieldset class={'reduce-fs-padding'} title={'Kana'}>
                <ButtonList class={'vertical'} children={kanaExams} />
              </Fieldset>
            </Content>
            <Content colSize={'column'}>
              <Fieldset class={'reduce-fs-padding'} title={'Kanji'}>
                <ButtonList class={'vertical'} children={kanjiExams} />
              </Fieldset>
            </Content>
          </Row>
          <Row colSize={'column two'}>
            <Content colSize={'column'}>
              <Form id={'selected-exam-form'} onSubmit={this.submitHandler}>
                <Fieldset title={this.state.selectedExam}>
                  ...
                  <p>
                    The settings below only affect the current exam. To change your default global settings,{' '}
                    <NavLink className="highlight" to={'/settings'}>
                      click here
                    </NavLink>
                    .
                  </p>
                  ...
                  <FormGroup key={'exam-settings'} id={'exam-settings'}>
                    ...
                    <FormField key={'method-settings'} value={this.state.methodSettings}>
                      <Select name={'method-settings'} title={'Method'} id={'method-select'} children={methodOptions} />
                    </FormField>
                  </FormGroup>

                  <Button
                    key={'selected-exam-form-btn'}
                    type={'submit'}
                    title={'Start exam'}
