    ...
    return (
      <Section id={'landing'} title={'Kotoba'} titleClass={'font-xxl'}>
        <Content colSize={'column two'}>
          <p>
            Memorize Japanese characters and vocabulary. Use the default exams, generate new exams based on your results
            or create a custom exam yourself!
          </p>
          ...
          <Form id={'login-form'} onSubmit={this.submitHandler}>
            ...
            <Button key={'login-form-btn'} type={'submit'} title={'Submit'} className={'btn-primary btn-main'} />
          </Form>
        </Content>
      </Section>
    );
